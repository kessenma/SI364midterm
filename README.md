...
Project Goal: Create a Flask database to ask users about their favorite TV show. 

1.) Routes: 
	1) / 			#home
	2) /404			#404 error
	3) /500			#500 error 
	4) /users		#All of users in the database
	5) /Shows		#All of the songs in the database  

2.) Database name:	kessen364midterm
	tables in database: 1.) Users, 2.) Shows
...
## in this lecture https://paper.dropbox.com/doc/SI-364-W18-Lecture-6-February-9-2018-More-on-Models-Frc7QS2dfcjk2KxmhgdEY
